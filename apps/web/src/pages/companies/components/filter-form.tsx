                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent className="max-w-xs bg-slate-700">
                            <p>{t('companies.segments.form.segmentTypeTooltip')}</p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </FormLabel>
                    <FormControl>
                      ...
                      >
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          ...
                          <FormLabel className="font-normal">{t('companies.segments.form.filter')}</FormLabel>
                        </FormItem>
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          <FormControl>
                            <RadioGroupItem value="MANUAL" />
                          </FormControl>
                          <FormLabel className="font-normal">{t('companies.segments.form.manual')}</FormLabel>
                        </FormItem>
                      </RadioGroup>
                    </FormControl>
                  </FormItem>
