      ...
      <div className="flex flex-col space-y-6 w-full max-w-screen-xl mx-auto p-14 mt-12  ">
        <SessionItemContainer className="grid grid-cols-2 gap-2 gap-x-12">
          <div className="border-b flex flex-col pb-1">
            <span className="text-sm text-foreground/60">{t('users.sessions.detail.fields.user')}</span>
            <Link
          ...
          <div className="border-b flex flex-col pb-1">
            <span className="text-sm text-foreground/60">{t('users.sessions.detail.fields.version')}</span>
            <Link
              className="text-primary"
          ...
          <div className="border-b flex flex-col pb-1">
            <span className="text-sm text-foreground/60">{t('users.sessions.detail.fields.started')}</span>
            <span>
              {session?.createdAt &&
          ...
          <div className="border-b flex flex-col pb-1">
            <span className="text-sm text-foreground/60">{t('users.sessions.detail.fields.startReason')}</span>
            <span>{getStartReasonTitle(startEvent)}</span>
          </div>
        </SessionItemContainer>
        <SessionItemContainer>
          <div className="mb-2 flex flex-row items-center font-bold	">{t('users.sessions.detail.progress')}</div>
        ...
        {answerEvents && answerEvents.length > 0 && (
          <SessionItemContainer>
            <div className="mb-2 flex flex-row items-center font-bold">{t('users.sessions.detail.response')}</div>
            ...
            <Table>
              <TableBody>
                {bizEvents ? (
                  ...
                  <TableRow>
                    <TableCell className="h-24 text-center">{t('users.sessions.detail.noEvents')}</TableCell>
                  </TableRow>
                )}
              </TableBody>
            </Table>
