...
export const columns: ColumnDef<BizSession>[] = [
  {
    ...
    header: ({ column }) => {
      ...
      return <DataTableColumnHeader column={column} title={t('contents.analytics.sessionsTable.user')} />;
    },
    cell: ({ row }) => {
  ...
  },
  {
    ...
    header: ({ column }) => {
      const { t } = useTranslation();
      return <DataTableColumnHeader column={column} title={t('contents.analytics.sessionsTable.progress')} />;
    },
    cell: ({ row }) => {
      const { environment } = useAppContext();
  ...
  },
  {
    ...
    header: ({ column }) => {
      const { t } = useTranslation();
      return <DataTableColumnHeader column={column} title={t('contents.analytics.sessionsTable.lastActivity')} />;
    },
