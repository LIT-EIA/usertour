      ...
      <DialogContent className="max-w-2xl	">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleOnSubmit)}>
            <DialogHeader>
              <DialogTitle>{t('contents.create.title', { type: t('contents.types.flow') })}</DialogTitle>
            </DialogHeader>
                  ...
                  <FormItem className="flex flex-row items-center space-x-1 space-y-0">
                    ...
                    <FormControl>
                      <div className="flex flex-col space-x-1 w-full grow">
                        <Input placeholder={t('contents.create.namePlaceholder', { type: t('contents.types.flow') })} {...field} id="flow-name-input" />
                        <FormMessage />
                      </div>
                    </FormControl>
                  </FormItem>
