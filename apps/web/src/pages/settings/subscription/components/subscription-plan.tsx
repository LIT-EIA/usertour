    ...
    <>
      <div className="flex flex-col divide-zinc-950/5 dark:divide-white/5">
        <div className="py-8 grid grid-cols-1 sm:grid-cols-8 gap-x-12 gap-y-4">
          <div className="col-span-3 flex flex-col gap-1">
            <div className="flex flex-wrap gap-2">
              <h1 className="text-zinc-950/90 dark:text-white/90">{t('settings.subscription.heading')}</h1>
            </div>
                      ...
                      <>
                        ...
                        {licenseInfo?.payload?.exp && (
                          <span className="text-red-500">
                            {t('settings.subscription.expiresOn', { date: formatDate(new Date(licenseInfo.payload.exp * 1000), 'PP') })}
                          </span>
                        )}
                      </>
                    )}
        ...
        <div className="py-8 flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-col gap-1">
              <div className="text-sm font-medium">{t('settings.subscription.uploadLicenseLabel')}</div>
              <div className="text-zinc-950/50 dark:text-white/50 text-sm">
