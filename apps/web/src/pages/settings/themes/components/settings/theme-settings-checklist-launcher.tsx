  ...
  return (
    <div className="flex flex-col space-y-4">
      <div className="py-[15px] px-5 space-y-3">
        ...
        <div className="space-y-1">
          <div className="text-sm">{t('themeBuilder.fields.checklistLauncher.counterFontColor')}</div>
          <div className="flex">
            <ThemeColorPicker
        ...
        <div className="space-y-1">
          <div className="text-sm">{t('themeBuilder.fields.checklistLauncher.counterBackgroundColor')}</div>
          <div className="flex">
            <ThemeColorPicker
