...
export const ThemeSettingsProgress = () => {
  ...
  const progressTypeItems = [
    {
      name: t('themeBuilder.options.progressBarType.fullWidth'),
      value: ProgressBarType.FULL_WIDTH,
    },
    { name: t('themeBuilder.options.progressBarType.narrow'), value: ProgressBarType.NARROW },
    {
      name: t('themeBuilder.options.progressBarType.chainRounded'),
      value: ProgressBarType.CHAIN_ROUNDED,
    },
    {
      name: t('themeBuilder.options.progressBarType.chainSquared'),
  ...
  const positionItems = [
    ...
    {
      name: t('themeBuilder.options.progressBarPosition.bottom'),
  ...
  const getHeightInputProps = () => {
    switch (settings.progress.type) {
      case ProgressBarType.FULL_WIDTH:
        return {
          text: t('themeBuilder.fields.progress.progressBarHeight'),
