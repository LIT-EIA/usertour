                      ...
                      >
                        <FormControl>
                          <SelectTrigger className="w-72">
                            <SelectValue
                              placeholder={t('settings.attributes.form.bizTypePlaceholder')}
                            />
                          </SelectTrigger>
                        </FormControl>
                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger className="w-72">
                            <SelectValue
                              placeholder={t('settings.attributes.form.dataTypePlaceholder')}
                            />
                          </SelectTrigger>
                        </FormControl>
                        <SelectContent className="w-72">
                          <SelectItem value={String(BizAttributeTypes.Number)}>
                            {t('settings.attributes.form.dataTypes.number')}
                          </SelectItem>
                          <SelectItem value={String(BizAttributeTypes.String)}>
                            {t('settings.attributes.form.dataTypes.string')}
                          </SelectItem>
                          <SelectItem value={String(BizAttributeTypes.Boolean)}>
                            {t('settings.attributes.form.dataTypes.boolean')}
                          </SelectItem>
                          ...
                          <SelectItem value={String(BizAttributeTypes.List)}>
                            {t('settings.attributes.form.dataTypes.list')}
                          </SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
