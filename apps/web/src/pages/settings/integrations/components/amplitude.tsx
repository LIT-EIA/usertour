...
interface IntegrationFormProps {
  ...
  onSave: (updates: Partial<AmplitudeIntegrationConfig>) => Promise<void>;
...
const ExportEventsForm = ({
  ...
  const config = (integration?.config as AmplitudeIntegrationConfig) || {};
      ...
      <CardHeader>
        <CardTitle className="space-between flex items-center gap-2 flex-row items-center">
          ...
          <Label className="text-sm">
            {t('settings.integrations.providerCard.headline', { provider: 'Amplitude' })}
          </Label>
          <QuestionTooltip>
            {t('settings.integrations.providerCard.tooltip', { provider: 'Amplitude' })}
          </QuestionTooltip>
        </CardTitle>
        <CardDescription>
      ...
      {config.exportEvents && (
        <CardContent className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            <p className="text-sm">{t('settings.integrations.providerCard.apiKeyLabel')}</p>
            <Input
              type="text"
              placeholder={t('settings.integrations.providerCard.apiKeyPlaceholder')}
          ...
          <div className="flex flex-col gap-1">
            ...
            >
              <SelectTrigger>
                <SelectValue
                  placeholder={t('settings.integrations.providerCard.regionDefaultUS')}
                />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="US">
          ...
          <CardTitle className="space-between flex items-center gap-4 flex-row items-center">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="text-sm text-muted-foreground font-normal">
                {t('settings.integrations.descriptions.amplitude')}{' '}
                <a
                ...
                >
                  <span>
                    {t('settings.integrations.providerHeaderReadGuide', { provider: 'Amplitude' })}
                  </span>
