...
export const LocalizationDeleteForm = (props: {
  ...
  return (
    <AlertDialog defaultOpen={open} open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>{t('settings.common.deleteConfirm.title', { resource: t('settings.localizations.deleteResource') })}</AlertDialogTitle>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction onClick={handleDeleteSubmit}>{t('settings.common.deleteConfirm.confirm', { resource: t('settings.localizations.deleteResource') })}</AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
  );
