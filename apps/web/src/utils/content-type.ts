...
const FEMININE_CONTENT_TYPES: ReadonlySet<string> = new Set([
  'checklist',
  'banner',
  'announcement',
]);

export const getContentTypeGenderContext = (contentType?: string | null): 'feminine' | undefined =>
  contentType && FEMININE_CONTENT_TYPES.has(contentType) ? 'feminine' : undefined;
