const translations = {
  ...
  dataTable: {
    ...
    rowsSelectedOf: '{{selected}} of {{total}} row(s) selected.',
  },
  segments: {
    sidebar: {
      new: 'New',
  ...
  settings: {
    ...
    attributes: {
      ...
      form: {
        ...
        descriptionTooltip: 'Put any additional information for your own reference here.',
        bizTypes: {
          user: 'User',
          company: 'Company',
          membership: 'Company Membership',
    ...
    environments: {
      ...
      createFailure: 'Failed to create environment.',
    ...
    themes: {
      ...
      createFailure: 'Failed to create theme.',
      setAsDefaultLabel: 'Set as default theme',
      renameTitle: 'Rename theme',
      renameFailure: 'Failed to rename theme.',
      listHeader: {
        newTheme: 'New theme',
        description:
    ...
    team: {
      ...
      changeRole: {
        ...
        missingIds: 'Project ID or User ID is missing.',
      },
      cancelInvite: {
        title: 'Cancel invite',
        description:
    ...
    billing: {
      ...
      comparison: {
        ...
        rows: {
          ...
          liveChatAndEmailSupport: 'Live-chat and email support',
    ...
    subscription: {
      ...
      invalidFileType: 'Please select a text file (.txt) or license file (.license)',
      fileTooLarge: 'Please select a file smaller than 10KB',
      emptyFileToast: 'Empty file',
    },
    sso: {
    ...
    integrations: {
      ...
      descriptions: {
        amplitude: 'Send Usertour events to Amplitude and receive Amplitude Cohorts.',
        heap: 'Send Usertour events to Heap and sync Heap segments into Usertour.',
        hubspot: 'Send Usertour events to HubSpot and sync properties back into Usertour.',
        mixpanel: 'Send Usertour events to Mixpanel and receive Mixpanel Cohorts.',
        posthog: 'Write data directly to Posthog to power analytics, user targeting, and more.',
        salesforce: 'Send Usertour events to Salesforce and sync properties back into Usertour.',
        salesforceSandbox: 'Test your Salesforce integration in a safe environment.',
        segment: 'Send Usertour events to Segment and sync properties back into Usertour.',
        zapier: 'Connect Usertour to 3,000+ apps with Zapier to automate your workflows.',
      },
      salesforce: {
  ...
  users: {
    ...
    dialogs: {
      ...
      deleteUsers: {
        ...
        description_one:
          'This will delete all traces of the user from your account. Including in analytics.',
        description_other:
          'This will delete all traces of the selected users from your account. Including in analytics.',
        confirmQuestion_one: 'Confirm deleting the user?',
        confirmQuestion_other: 'Confirm deleting the users?',
        confirmButton_one: 'Yes, delete this user',
        confirmButton_other: 'Yes, delete {{count}} users',
      },
      deleteSegment: {
    ...
    detail: {
      ...
      attributeColumns: { name: 'Name', value: 'Value' },
    },
    segments: {
    ...
    sidebar: {
      title: 'Users',
      new: 'New',
      createSegmentTooltip: 'Create user segment',
      segments: 'Segments',
    },
    table: {
      user: 'User',
  ...
  contents: {
    ...
    create: {
      ...
      extensionBuilderHint: 'Open the builder in new tab for WYSIWYG editing experience',
      webBuilderHint: 'Open the builder in the current tab for convenient editing experience',
      buildUrlRequired: 'Please enter the URL you want to add an experience to.',
    },
    list: {
      ...
      newButton: 'New {{type}}',
      totalCount: '{{count}} {{type}} in total.',
      allTab: 'All',
    ...
    detail: {
      ...
      editInExtensionBuilder: 'Edit In Extension Builder',
      editInWebBuilder: 'Edit In Web Builder',
      publish: 'Publish',
      autoStartConditionRequiredTitle: 'Auto-start condition required',
    ...
    analytics: {
      ...
      views: {
        ...
        launcher: {
          ...
          uniqueActivationRate: 'Unique activation rate',
          ...
          totalActivationRate: 'Total activation rate',
      ...
      chart: {
        ...
        uniqueActivations: 'Unique activations',
    ...
    listView: {
      card: {
        ...
        statusLabel: 'Status:',
        createdAtRelative: 'Created {{time}} ago',
      },
      loadingMore: 'Loading…',
    ...
    shared: {
      ...
      changeEnvironment: {
        title: 'Change Environment Assignment',
        description:
          'Select the environment this draft should be assigned to. Only drafts assigned to the selected environment will be visible in the Drafts section.',
        environmentLabel: 'Environment',
        selectPlaceholder: 'Select an environment',
        updateButton: 'Update',
        successToast: 'Environment assignment updated successfully',
        failureToast: 'Failed to update environment assignment.',
      },
      extensionInstall: {
        title: 'Install the Usertour Builder',
        description: 'Get the Chrome extension to continue.',
        builderName: 'The Usertour Builder',
        notInstalled: 'Not installed',
        extensionDescription:
          'The Usertour Builder Chrome extension lets you create and edit in-app experiences for websites.',
        notFound: 'Chrome extension not found, please try installing again.',
        installButton: 'Install Chrome extension',
      },
      rename: {
        title: 'Rename {{type}}',
        namePlaceholder: 'Enter {{type}} name',
    ...
    versions: {
      ...
      columns: { version: 'Version', createdAt: 'Created at', updatedAt: 'Updated at' },
    },
    goalStep: 'Goal step',
  },
  companies: {
    columns: {
      ...
      createdAt: 'Created at',
      name: 'Company Name',
      firstSeen: 'Company First Seen',
      lastSeen: 'Company Last Seen',
      signedUp: 'Company Signed Up',
    },
    actions: {
    ...
    segments: {
      ...
      allCompaniesName: 'All Companies',
      form: {
        name: 'Name',
    ...
    sidebar: {
      title: 'Companies',
      new: 'New',
      createSegmentTooltip: 'Create company segment',
      segments: 'Segments',
    },
    table: {
      company: 'Company',
  ...
  themeBuilder: {
    ...
    preview: {
      ...
      tooltipTargetLabel: 'Tooltip target',
    },
    chrome: {
      // Sidebar / top bar
      variations: 'Variations',
      conditionalVariationsLabel: 'Conditional variations',
    ...
    dialogs: {
      ...
      editVariation: {
        title: 'Edit conditional variation',
      },
      createVariation: {
        title: 'Create conditional variation',
      },
    },
    tooltips: {
      variations:
      ...
      deleteConditionVariation: 'Delete condition variation',
      ...
      checklistZIndex:
        "How high on the web page's z axis the checklist should appear. Leave empty to use Usertour's default behavior.",
      // Checklist launcher
    ...
    validation: {
      ...
      variationTitleRequired: 'Please enter a title for this variation',
      variationConditionRequired: 'Please add at least one condition',
    },
    alerts: {
      progressNonLinear:
    ...
    checklistPreview: {
      ...
      item1Name: 'First item',
      item2Name: 'Second item',
      item3Name: 'Third item',
    },
  },
  contentBuilder: {
    ...
    editor: {
      button: {
        ...
        actionGoTo: 'Go to step',
        actionSkip: 'Skip',
        actionDismiss: 'Dismiss flow',
      ...
      textInput: {
        ...
        singleLineConfigAriaLabel: 'Single line text configuration',
      },
      question: {
        ...
        npsLowLabelDefault: 'Not at all likely',
        npsHighLabelDefault: 'Extremely likely',
        invalidScaleRange: 'Invalid scale range',
        scaleOptionsLabel: 'Scale options',
        scaleOptionLabel: 'Scale option {{value}}',
      ...
      embed: {
        ...
        embeddedContentFrom: 'Embedded content from {{url}}',
      },
      image: {
        width: 'Image width',
      ...
      bindAttribute: {
        ...
        createForm: {
          ...
          objectTypeTooltip: 'Determines which kind of objects this attribute can be set for.',
          objectTypePlaceholder: 'Select an object type',
          objectTypeUser: 'User',
          objectTypeCompany: 'Company',
          objectTypeMembership: 'Company Membership',
          objectTypeEvent: 'Event',
          dataType: 'Data type',
          dataTypeTooltip: 'Determines what kind of values will be stored in this attribute.',
          dataTypePlaceholder: 'Select a data type',
          ...
          displayName: 'Display name',
          displayNameTooltip:
            'Human-friendly name shown in Usertour. We recommend using Word Case (uppercase first letter, spaces between words), such as "Billing Plan".',
          displayNamePlaceholder: 'Enter display name',
          displayNameHint: 'Can be changed later',
          displayNameRequired: 'Please enter a display name.',
          codeName: 'Code name',
          codeNameTooltip:
            'Code-friendly name used in webhooks and analytics integrations. We recommend using snake_case (lowercase letters with words separated by underscores).',
          codeNamePlaceholder: 'Enter code name',
          codeNameHint: 'Cannot be changed later',
          codeNameRequired: 'Please enter a code name.',
          nameMinLength: 'Must be at least 2 characters.',
          nameMaxLength: 'Must be at most 20 characters.',
          description: 'Description',
          descriptionTooltip: 'Add any additional information for your own reference here.',
          descriptionPlaceholder: 'Optional description',
          descriptionMaxLength: 'Must be at most 100 characters.',
          cancel: 'Cancel',
    ...
    shared: {
      ...
      manual: 'Manual',
      fixed: 'Fixed',
      alignmentOptionsAriaLabel: 'Alignment options',
      ...
      selectAnotherElement: 'Select another element',
      selectElementButton: 'Select element',
      selectElementError: 'Please select an element',
      dynamicText: 'Dynamic text',
      dynamicTextTooltip:
        "If the element's text is dynamic and may change, enable this to make Usertour find it without considering its current text.",
      precision: {
        label: 'Precision',
        tooltip:
          "How flexible Usertour should be when looking for the element. If Usertour can't find your element, try to make the precision looser. If Usertour tends to find the wrong element, try to make the precision stricter.",
        selectPlaceholder: 'Select a precision',
        loosest: 'Loosest',
        looser: 'Looser',
        loose: 'Loose',
        strict: 'Strict',
      ...
      elementSelector: {
        navigateToPage: 'Navigate to the page the element appears on',
        navigateToAnotherPage: 'Navigate to another page',
        selectElementHere: 'Select element here',
      },
    ...
    flow: {
      ...
      saveStepFailed: 'Failed to create step!',
      create: 'Create',
      trigger: 'Trigger',
      triggers: 'Triggers',
      addTrigger: 'Add trigger',
      addAtLeastOneCondition: 'Please add at least 1 condition',
      addAtLeastOneAction: 'Please add at least 1 action',
      edit: 'Edit',
      delete: 'Delete',
    ...
    launcher: {
      ...
      zIndex: 'Z-Index',
      target: 'Target',
      noElementSelected: 'No element selected yet.',
      targetSetting: 'Target setting',
      targetSettings: 'Target settings',
      tooltipSettings: 'Tooltip settings',
      behavior: 'Behavior',
      settings: 'Settings',
      settingsAriaLabel: 'Launcher settings',
      invalidSettingsData: 'Invalid settings data provided',
      saveFailed: 'Failed to save launcher!',
      placement: 'Placement',
    ...
    checklist: {
      ...
      saveFailed: 'Failed to save checklist!',
  ...
  conditions: {
    ...
    types: {
      ...
      currentPage: {
        ...
        removePattern: 'Remove URL pattern',
        docsLink: 'Read full URL pattern matching guide',
      },
      pageName: {
        label: 'Page name',
        editorTitle: 'If the page name…',
      },
      segment: {
        label: 'Segment',
      ...
      content: {
        ...
        searchFlowPlaceholder: 'Search flow…',
    ...
    standalone: {
      ...
      wait: {
        before: 'Wait',
        suffix: 'seconds',
        afterLabel: 'second before starting',
        tooltip:
  ...
  actions: {
    ...
    errors: {
      ...
      stepGoto: {
        ...
        stepNoLongerExists: 'Selected step no longer exists',
      },
      flowStart: {
  ...
  nav: {
    ...
    installUsertourJsSvgTitle: 'Usertour.js Installation',
    installPlugins: 'Install Plugins',
    documentation: 'Documentation',
    installToPublish: 'Install to publish',
    logoAlt: 'Usertour logo',
  },
  attributes: {
    typeChip: {
      number: 'NUMBER',
  ...
  plugins: {
    ...
    install: {
      bookmarkletsInstructions: 'Select your environments, then drag the buttons to your <em>Bookmarks Bar</em>.',
      bookmarkBarHintPrefix: 'If the bar is hidden, press',
      bookmarkBarHintSuffix: 'to display it.',
      testEnvironmentLabel: 'Test Environment',
      testEnvironmentPlaceholder: 'Select test environment',
      prodEnvironmentLabel: 'Prod Environment',
      prodEnvironmentPlaceholder: 'Select prod environment',
      helperBookmarklet: 'UserTour Helper',
      startBookmarklet: 'Start UserTour',
