...
const buildTranslatedConditionsTypeMapping = (t: TFunction) => {
  ...
  return {
    [AttributeDataType.Number]: conditionsTypeMapping[AttributeDataType.Number].map(
      translateOperator,
    ),
    [AttributeDataType.String]: conditionsTypeMapping[AttributeDataType.String].map(
      translateOperator,
    ),
    [AttributeDataType.Boolean]: conditionsTypeMapping[AttributeDataType.Boolean].map(
      translateOperator,
    ),
    [AttributeDataType.List]: conditionsTypeMapping[AttributeDataType.List].map(
      translateOperator,
    ),
    [AttributeDataType.DateTime]: conditionsTypeMapping[AttributeDataType.DateTime].map(
      translateOperator,
    ),
  };
};
