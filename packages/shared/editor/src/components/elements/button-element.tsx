  ...
  const handleAddLeft = () => {
    ...
    Transforms.insertNodes(
      editor,
      {
        type: 'button',
        data: {
          text: t('contentBuilder.editor.defaultContent.buttonText'),
          type: 'default',
          action: 'goto',
        },
        children: [{ text: '' }],
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="destructive">
                      {t('contentBuilder.editor.button.styleDestructive')}
                    </SelectItem>
                    <SelectItem value="outline">
                      {t('contentBuilder.editor.button.styleOutline')}
                    </SelectItem>
                  </SelectGroup>
                </SelectContent>
              </SelectPortal>
                  ...
                  <SelectGroup>
                    ...
                    <SelectItem value="dismiss">
                      <div className="flex">
                        <CloseIcon className="flex-none mx-2 my-1" />
                        <div className="grow">
                          {t('contentBuilder.editor.button.actionDismiss')}
                        </div>
                      </div>
                    </SelectItem>
                  </SelectGroup>
