            ...
            <div className="flex flex-col gap-2.5">
                  ...
                  <SelectPortal style={{ zIndex: zIndex + 2 }}>
                    <SelectContent>
                      <SelectGroup>
                        ...
                        <SelectItem value="fill">{t('contentBuilder.editor.width.fill')}</SelectItem>
                      </SelectGroup>
                    </SelectContent>
                  </SelectPortal>
                </Select>
              ...
              >
                ...
                <SelectPortal style={{ zIndex: zIndex + 2 }}>
                  <SelectContent>
                    <SelectGroup>
                      <SelectItem value="start">{t('contentBuilder.editor.column.alignTop')}</SelectItem>
                      <SelectItem value="center">{t('contentBuilder.editor.column.alignCenter')}</SelectItem>
                      <SelectItem value="end">{t('contentBuilder.editor.column.alignBottom')}</SelectItem>
                      <SelectItem value="space-between">{t('contentBuilder.editor.column.justifyBetween')}</SelectItem>
                      <SelectItem value="space-evenly">{t('contentBuilder.editor.column.justifyEvenly')}</SelectItem>
                      <SelectItem value="space-around">{t('contentBuilder.editor.column.justifyAround')}</SelectItem>
                    </SelectGroup>
                  </SelectContent>
                </SelectPortal>
              </Select>
