...
const buildItemMapping = (t: TFunction, container: HTMLElement | null) => [
  <ToolbarToggleItem
    value="bold"
    label={t('contentBuilder.editor.toolbar.bold.ariaLabel')}
    key={'bold'}
  >
    <MarkButton
      format="bold"
  ...
  <ToolbarToggleItem
    value="italic"
    label={t('contentBuilder.editor.toolbar.italic.ariaLabel')}
    key={'italic'}
  >
    <MarkButton
      format="italic"
  ...
  <ToolbarToggleItem
    value="color"
    label={t('contentBuilder.editor.toolbar.color.ariaLabel')}
    key={'color'}
  >
  ...
  <ToggleItemBlockButton
    format="code"
    key={'code'}
    tips={t('contentBuilder.editor.toolbar.code.tooltip')}
  >
    <CodeIcon />
  </ToggleItemBlockButton>,
  <ToggleItemBlockButton
    format="h1"
    key={'h1'}
    tips={t('contentBuilder.editor.toolbar.h1.tooltip')}
  >
    <H1Icon />
  </ToggleItemBlockButton>,
  <ToggleItemBlockButton
    format="h2"
    key={'h2'}
    tips={t('contentBuilder.editor.toolbar.h2.tooltip')}
  >
    <H2Icon />
  </ToggleItemBlockButton>,
  <ToggleItemBlockButton
    format="link"
    key={'link'}
    tips={t('contentBuilder.editor.toolbar.link.tooltip')}
  >
...
const buildAlignItem = (t: TFunction) => [
  <ToggleItemBlockButton
    format="left"
    key={'left'}
    tips={t('contentBuilder.editor.toolbar.alignLeft.tooltip')}
  >
    <TextAlignLeftIcon />
  </ToggleItemBlockButton>,
  <ToggleItemBlockButton
