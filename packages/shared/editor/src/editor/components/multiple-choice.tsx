                    ...
                    <div className="flex justify-center w-full">
                      <Button forSdk={true}>
                        {localData.buttonText ||
                          t('contentBuilder.editor.textInput.defaultButtonText')}
                      </Button>
                    </div>
                  </div>
                )}
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => handleDataChange({ buttonText: e.target.value })}
                        placeholder={t(
                          'contentBuilder.editor.multipleChoice.submitButtonPlaceholder',
                        )}
                      />
                    </div>
                  </>
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="shuffle">
                      {t('contentBuilder.editor.multipleChoice.shuffle')}
                    </Label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="other">
                      {t('contentBuilder.editor.multipleChoice.enableOther')}
                    </Label>
                  </div>
