                      ...
                      <SelectContent>
                        <SelectGroup>
                          ...
                          <SelectItem value="loose">
                            <div className="flex">
                              {t('contentBuilder.shared.precision.loose')}
                            </div>
                          </SelectItem>
                  ...
                  <div className="flex space-x-2 grow">
                    <Label htmlFor="dynamic-content" className="flex flex-col space-y-1">
                      <span className="font-normal">
                        {t('contentBuilder.shared.dynamicText')}
                      </span>
                    </Label>
                    <TooltipProvider>
                      <Tooltip>
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          ...
                          <p>
                            {t(
                              'contentBuilder.shared.ifMultipleMatchesTooltip',
                            )}{' '}
                          </p>
                        </TooltipContent>
                      </Tooltip>
                      ...
                      <SelectContent>
                        <SelectGroup>
                          <SelectItem value="1st">
                            <div className="flex">
                              {t('contentBuilder.shared.selectElement.1')}
                            </div>
                          </SelectItem>
                          <SelectItem value="2st">
                            <div className="flex">
                              {t('contentBuilder.shared.selectElement.2')}
                            </div>
                          </SelectItem>
                          <SelectItem value="3st">
                            <div className="flex">
                              {t('contentBuilder.shared.selectElement.3')}
                            </div>
                          </SelectItem>
                          <SelectItem value="4st">
                            <div className="flex">
                              {t('contentBuilder.shared.selectElement.4')}
                            </div>
                          </SelectItem>
                          <SelectItem value="5st">
                            <div className="flex">
                              {t('contentBuilder.shared.selectElement.5')}
                            </div>
                          </SelectItem>
                        </SelectGroup>
                      </SelectContent>
