...
const buildTriggerEventOptions = (t: TFunction) =>
  [
    { value: LauncherTriggerEvent.HOVERED, label: t('contentBuilder.launcher.behaviorEditor.triggerEvent.hovered') },
    { value: LauncherTriggerEvent.CLICKED, label: t('contentBuilder.launcher.behaviorEditor.triggerEvent.clicked') },
  ] as const;
          ...
          >
            ...
            >
              <div className="flex flex-row space-x-1 items-center">
                ...
                <span className="text-sm">{t('contentBuilder.launcher.behaviorEditor.tooltipSetting')}</span>
              </div>
