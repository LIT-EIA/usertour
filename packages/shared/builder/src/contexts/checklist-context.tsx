  ...
  const update = useCallback(
    async (newData: ChecklistData) => {
      ...
      try {
        ...
        toast({
          variant: 'destructive',
          title: error instanceof Error ? error.message : t('contentBuilder.checklist.saveFailed'),
        });
      } finally {
        setIsLoading(false);
      }
    },
    [currentVersion, updateContentVersionMutation, fetchContentAndVersion, toast, setIsLoading, t],
  );
