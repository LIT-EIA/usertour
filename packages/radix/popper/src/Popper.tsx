      ...
      middleware: [
        ...
        size({
          ...
          apply: ({ elements, rects, availableWidth, availableHeight }) => {
            ...
            contentStyle.setProperty('--usertour-popper-available-width', `${availableWidth}px`);
            contentStyle.setProperty('--usertour-popper-available-height', `${availableHeight}px`);
            contentStyle.setProperty('--usertour-popper-anchor-width', `${anchorWidth}px`);
            contentStyle.setProperty('--usertour-popper-anchor-height', `${anchorHeight}px`);
          },
        }),
    ...
    return (
      <div
        ...
        style={{
          ...
          ['--usertour-popper-transform-origin' as any]: [
